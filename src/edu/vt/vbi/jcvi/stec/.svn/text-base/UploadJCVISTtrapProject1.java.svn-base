...
public class UploadJCVISTtrapProject1 {
	Connection conn;

	public UploadJCVISTtrapProject1() {
		try {
	...
	public static void main(String[] args) {
		UploadJCVISTtrapProject1 p=new UploadJCVISTtrapProject1();
		int pid=6;
		
		String tableName="JCVI_STRAP_PROJ1";
