...
public class UploadJCVISTtrapProject3 {
	Connection conn;

	public UploadJCVISTtrapProject3() {
		try {
	...
	public static void main(String[] args) {
		...
		UploadJCVISTtrapProject3 p=new UploadJCVISTtrapProject3();
		int pid=8;
		
		String tableName="JCVI_STRAP_PROJ3";
