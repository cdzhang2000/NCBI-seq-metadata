...
public class UploadBurkholderia {
	Connection conn;
	
	public UploadBurkholderia(){
		try {
	...
	private void updateATTVALUETable(int subpid, String colName) throws SQLException{
		...
		"(select '"+subpid+"', attr_id," +colName + " from SEQUENCEMETA.BURKHOLDERIACORE SU," +
	...
	public static void main(String[] args) {
		UploadBurkholderia p=new UploadBurkholderia();
		int pid=1;
